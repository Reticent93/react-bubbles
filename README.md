...
- [ ] What steps can you take in your web apps to keep your data secure?
  create a token, have protected routes
- [ ] Describe how web servers work.


  they work like magic. (haha). for example, if i need to go out to google.com to get a picture of a car, it makes an get request to google's server. servers can be other computers. so my computer says "do you have a picture of a car?' and google says 'yes, what type of car do you need?'
